    ...
    <div className="App">
      ...
      <div className="resume_left">
        <div className="resume_profile">
          <img src="https://media-exp1.licdn.com/dms/image/C4D03AQF4-epiyaHhmw/profile-displayphoto-shrink_200_200/0?e=1586390400&v=beta&t=gtSP8zJdje0-l_TTx9ED4-Hk4aBLCM1fYB7_O2b8MEs" alt="profile_pict"/>
        </div>
          ...
          <div className="resume_item resume_info">
            ...
            <ul>
              ...
              <li>
                ...
                <div className="data">
                  dawitjtilahun@gmail.com
                </div>
              </li>
              <li>
                <div className="icon"><i className="fab fa-firefox-browser"></i></div>
                <div className="data">
                  www.dawitjtilahun.com
                </div>
              </li>
            </ul>
          </div>
      ...
      <div className="resume_right">
        <div className="resume_item resume_about">
          <div className="title">
            ...
            <p>I am studying programming at Foocoding. After completing the course, I want to work as website developer and can employ the knowledge and skill I gain through the training if given the opportunity by designing attractive and interactive websites which inturn would help me improve my skills. 
              <br/>I am also an experienced Lecturer with a demonstrated history of working in the higher education industry. Skilled in Lecturing, and Academic Writing in Descriptive and Historical-Comparative Linguistics.
              Strong education professional with a Higher Diploma in Professional Teacher Educator focused in Education from Dilla University.</p>
        </div>
        ...
        <div className="resume_item resume_hobby">
          ...
          <ul>
            <li><i className="fas fa-book" aria-hidden="true"></i></li>       
            <li><i className="fas fa-gamepad" aria-hidden="true"></i></li>
            <li><i className="fas fa-music" aria-hidden="true"></i></li>
            <li><i className="fab fa-pagelines" aria-hidden="true"></i></li>
          </ul>
        </div>        
       </div>
  </div>
